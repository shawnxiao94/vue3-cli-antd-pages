<!--
 * @Author: shawnxiao
 * @Date: 2021-02-01 11:47:31
 * @LastEditTime: 2021-02-08 09:25:59
 * @FilePath: /vue3-cli-antd-pages/src/pages/index/views/Error/403.vue
-->
<template>
        ...
        <a-col :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
          <div class="pic-error">
            <img
              ...
              src="@index/assets/images/common/404.png"
            />
            <img
              class="pic-error-child left"
              src="@index/assets/images/common/cloud.png"
            />
          </div>
        </a-col>
